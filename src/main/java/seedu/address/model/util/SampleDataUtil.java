        ...
        try {
            return new Place[] {
                ...
                new Place(new Name("Marina Bay Sands"), new Phone("66888868"),
                        new Website("www.marinabaysands.com"),
